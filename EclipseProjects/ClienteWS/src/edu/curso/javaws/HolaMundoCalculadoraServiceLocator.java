...
public class HolaMundoCalculadoraServiceLocator extends org.apache.axis.client.Service implements edu.curso.javaws.HolaMundoCalculadoraService {
    ...
    public edu.curso.javaws.HolaMundoCalculadora getHolaMundoCalculadora() throws javax.xml.rpc.ServiceException {
    ...
    public edu.curso.javaws.HolaMundoCalculadora getHolaMundoCalculadora(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            edu.curso.javaws.HolaMundoCalculadoraSoapBindingStub _stub = new edu.curso.javaws.HolaMundoCalculadoraSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (edu.curso.javaws.HolaMundoCalculadora.class.isAssignableFrom(serviceEndpointInterface)) {
                edu.curso.javaws.HolaMundoCalculadoraSoapBindingStub _stub = new edu.curso.javaws.HolaMundoCalculadoraSoapBindingStub(new java.net.URL(HolaMundoCalculadora_address), this);
                _stub.setPortName(getHolaMundoCalculadoraWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://javaws.curso.edu", "HolaMundoCalculadoraService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://javaws.curso.edu", "HolaMundoCalculadora"));
        }
